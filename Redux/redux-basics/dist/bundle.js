...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jquery__ = __webpack_require__(25);
...
function addTodoAsync(text) {
    return function (dispatch) {
        ...
        __WEBPACK_IMPORTED_MODULE_2_jquery___default.a.ajax(url, {
            method: 'POST',
...
//-----------------------------------------------------------
let rootReducer = __WEBPACK_IMPORTED_MODULE_0_redux__["b" /* combineReducers */]({
...
const store = __WEBPACK_IMPORTED_MODULE_0_redux__["c" /* createStore */](
    rootReducer,
    __WEBPACK_IMPORTED_MODULE_0_redux__["a" /* applyMiddleware */](__WEBPACK_IMPORTED_MODULE_1_redux_thunk___default.a),
    window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__()
);
